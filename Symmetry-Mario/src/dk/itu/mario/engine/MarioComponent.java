...
import dk.itu.mario.scene.LevelSceneTestLoad;
...
public class MarioComponent extends JComponent implements Runnable, KeyListener, FocusListener, MouseListener
	{
		    ...
		    public void toCustomGame(){
		    	...
		    	{
		    	randomLevel = new LevelSceneTestLoad(graphicsConfiguration,this,new Random().nextLong(),0,0,true,nameFile,typeTask);	
		    	}	
		    	Mario.fire = false;
		    	Mario.large = false;
		    	Mario.coins = 0;
